...
{
    [CustomEditor (typeof (ThemeUIPanelGroup), true)]
    public class ThemeUIPanelGroupEditor : Editor 
    {
        //Private Variables:
        ThemeUIPanelGroup _target;

        //Init:
        void OnEnable()
        {
            _target = target as ThemeUIPanelGroup;
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                DrawNotification("Add child ThemeUIPanels for this State Machine to control.", Color.yellow);
                return;
            }
