...
{
    [CustomEditor (typeof (HueUIPanelGroup), true)]
    public class HueUIPanelGroupEditor : Editor 
    {
        //Private Variables:
        HueUIPanelGroup _target;

        //Init:
        void OnEnable()
        {
            _target = target as HueUIPanelGroup;
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                DrawNotification("Add child HueUIPanels for this State Machine to control.", Color.yellow);
                return;
            }
